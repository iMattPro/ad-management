...
$lang = array_merge($lang, array(
	...
	'AD_START_DATE_EXPLAIN'		=> 'Set the date the advertisement will start and become enabled. If no date is set, the advertisement will not start automatically in the future. All dates use UTC.',
	'AD_END_DATE'				=> 'End Date',
	'AD_END_DATE_EXPLAIN'		=> 'Set the date the advertisement will expire and become disabled. If no date is set, the advertisement will not expire. All dates use UTC.',
